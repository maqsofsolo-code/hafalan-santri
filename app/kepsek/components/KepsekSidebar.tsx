...
// Menu tetap flat (tidak dikelompokkan) -- Tahap 7A hanya modularisasi
// struktur file, BUKAN redesign navigasi (beda dari Admin Tahap 6B).
...
// app/kepsek/page.tsx (Modularisasi Tahap 7A), dipisah dari KepsekSidebarNav
// supaya nesting DOM tetap identik dengan sebelumnya -- pola sama persis
// dengan AdminMobileHeader/AdminSidebarNav (Tahap 6A) dan
// GuruMobileHeader/GuruSidebarNav (Tahap 5A).
export function KepsekMobileHeader(props: { sidebarOpen: boolean, setSidebarOpen: (open: boolean) => void }) {
...
export function KepsekSidebarNav(props: {
  activeMenu: string
  ...
  const { activeMenu, onSelectMenu, sidebarOpen, setSidebarOpen, onLogout, isUjian } = props
  return (
