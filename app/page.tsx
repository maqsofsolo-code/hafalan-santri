    ...
    <div className="min-h-screen bg-green-50 flex items-center justify-center p-4">
      <div className="bg-white rounded-2xl shadow-lg w-full max-w-md p-6 md:p-8">
        ...
        <div className="text-center mb-8">
          ...
          <h1 className="text-2xl font-bold text-green-800">Sistem Hafalan Santri</h1>
        ...
        <div className="space-y-4">
          <div>
            ...
            <input
              ...
              className="w-full border border-gray-300 rounded-lg px-4 py-3 focus:outline-none focus:ring-2 focus:ring-green-400 text-base"
            />
          </div>
          ...
          <button
            onClick={handleLogin}
            disabled={loading}
            className="w-full bg-green-700 text-white py-4 rounded-xl font-semibold hover:bg-green-800 transition disabled:opacity-50 text-lg mt-2 active:bg-green-900"
          >
